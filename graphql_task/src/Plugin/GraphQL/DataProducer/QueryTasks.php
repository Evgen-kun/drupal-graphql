 ...
 * )
 */
class QueryTasks extends DataProducerPluginBase implements ContainerFactoryPluginInterface {
   ...
   *
   * @return \Drupal\graphql_task\Wrappers\Response\QueryConnection
  ...
  public function resolve($offset, $limit, RefinableCacheableDependencyInterface $metadata) {
    ...
    $query->condition($entityType->getKey('bundle'), 'task');
